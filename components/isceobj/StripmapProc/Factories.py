...
def isRawSensor(sensor):
    ...
    '''
    if str(sensor).lower() in ["terrasarx","cosmo_skymed_slc","cosmo_skymed_2gen_slc","radarsat2",'tandemx', 'kompsat5','risat1_slc','sentinel1', 'alos2','ers_slc','alos_slc','envisat_slc', 'uavsar_rpi','ers_envisat_slc','sicd_rgzero', 'iceye_slc', 'uavsar_hdf5_slc', 'saocom_slc', 'lutan1']:
        return False
    else:
        return True
...
def isZeroDopplerSLC(sensor):
    ...
    if str(sensor).lower() in ["terrasarx","cosmo_skymed_slc","cosmo_skymed_2gen_slc","radarsat2",'tandemx', 'kompsat5','risat1_slc','sentinel1', 'alos2','ers_slc','envisat_slc','ers_envisat_slc','sicd_rgzero', 'iceye_slc', 'uavsar_hdf5_slc', 'saocom_slc', 'lutan1']:
        return True
...
def getDopplerMethod(sensor):
    ...
    if str(sensor).lower() in ["terrasarx","cosmo_skymed_slc","cosmo_skymed_2gen_slc","radarsat2",'tandemx', 'kompsat5','risat1_slc','sentinel1', 'alos2','ers_slc','alos_slc','envisat_slc', 'uavsar_rpi','cosmo_skymed','ers_envisat_slc','sicd_rgzero', 'iceye_slc', 'uavsar_hdf5_slc', 'saocom_slc', 'roi_pac','lutan1']:
        res =  'useDEFAULT'
    else:
        res =  'useDOPIQ'
